...
$${#eq:henry}
である．ここでp_{\mathrm{O_2}}は気泡側の酸素分圧である．Henryの式の他，水深による補正式として以下の式が用いられることもある．
...
である．ここで$Sh$はシャーウッド数，$D_{\mathrm{AB}}$は液相中の対象成分の拡散係数[m2/s]，$d$は代表長さであり，一般に気泡径が用いられる．$D_{\mathrm{AB}}$は温度依存性があるが，常温の純粋では$1.97 \times 10^{-9} \mathrm{m^2/s}$である．Sh数の相関式が難しく，FluentではRanz-Marshall型相関式が用いられるようである．Ranz-Marshallの式は球状物体から流体への熱・物質移動のアナロジーとして求められる．
